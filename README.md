...
2. Install ansible
   ...
   > It is **important** to install ansible with **pip** because with apt you don't get the latest version
...
4. Copy `config.yml.example` to `config.yml` and customize it to your liking
